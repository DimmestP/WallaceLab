...
for(idx in 1:2000){
simulated_observed_total_RNA_counts[idx] <- rnbinom(1,negbin_alpha_observed*as.integer(real_tot_simulated$simulated_actual_total_RNA_counts[idx]), negbin_phi)
}
