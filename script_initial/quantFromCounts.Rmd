...
Version: 0.2
Authors@R: c(person("Edward", "Wallace", email = "edward.wallace@ed.ac.uk", role = "aut", person("Samuel Joseph", "Haynes", email = "e1895111@ed.ac.uk", role = "cre")
...
# Separate the open reading frames with sufficient transcript counts in all four conditions, ignore other data.
wd5_TSP_Tot <- 
    TSP_Count_TPM %>%
    filter(Fraction=="Tot") %>%
    group_by(ORF) %>%
